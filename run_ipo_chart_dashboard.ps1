...
Log "--- Git commit+push ---"
& git -C C:\Users\satya\nse_circuit_limits add dashboard/ipo_charts.html 2>&1 | ForEach-Object { $_ | Tee-Object -FilePath $logFile -Append }
...
# schtasks /create /tn "NSE_IPOChartDashboard" /tr "powershell -NonInteractive -File C:\Users\satya\nse_circuit_limits\run_ipo_chart_dashboard.ps1" /sc WEEKLY /d MON,TUE,WED,THU,FRI /st 16:38 /f

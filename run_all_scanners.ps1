...
Run-Scanner "Near52WHigh"          "$ROOT\run_near_52w_high_scanner.ps1"
Run-Scanner "IPOScanner"           "$ROOT\run_ipo_scanner.ps1"
Run-Scanner "UnionChartDashboard"  "$ROOT\run_union_chart_dashboard.ps1"
Run-Scanner "TVWatchlistDashboard" "$ROOT\run_tradingview_watchlist_dashboard.ps1"
Run-Scanner "Near52WHighChartDash" "$ROOT\run_near_52w_high_chart_dashboard.ps1"
Run-Scanner "IPOChartDashboard"    "$ROOT\run_ipo_chart_dashboard.ps1"

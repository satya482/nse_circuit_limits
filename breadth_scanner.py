...
<style>
  * {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .li {{ display: flex; align-items: center; gap: 7px; font-size: 0.75rem; color: #999; cursor: pointer; }}
  .li:hover {{ color: #ddd; }}
...
<div class="card">
  ...
  <div class="legend">
    ...
    <div class="li" onclick="toggleLine(1)"><div class="swatch" style="background:#fb923c"></div>% &gt; SMA20</div>
    <div class="li" onclick="toggleLine(2)"><div class="swatch" style="background:#34d399"></div>% &gt; SMA50</div>
    <div class="li" onclick="toggleLine(3)"><div class="swatch" style="background:#f87171"></div>% &gt; SMA200</div>
    <div class="li" onclick="toggleLine(4)"><div class="swatch dashed"></div>NIFTY MidSml 400 (norm.)</div>
  </div>
...
const DATASETS = [
  {{ label: '% > SMA10',  key: 'p10',  color: '#60a5fa', width: 1.5 }},
  {{ label: '% > SMA20',  key: 'p20',  color: '#fb923c', width: 1.5 }},
  {{ label: '% > SMA50',  key: 'p50',  color: '#34d399', width: 2.0 }},
  {{ label: '% > SMA200', key: 'p200', color: '#f87171', width: 2.5 }},
  {{ label: 'NIFTY MidSml 400 (norm.)', key: 'bench', color: '#a78bfa', width: 1, dash: [5,3] }},
];
